...
This would require the program to acknowledge a clue (when found) and how it affects the rest of the variables within the game. Furthermore, the playability relies on how the game would advance when more evidence is accumulated. 
